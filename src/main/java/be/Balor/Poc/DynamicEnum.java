...
public class DynamicEnum {
	...
	private static void cleanEnumCache(Class<?> enumClass) throws NoSuchFieldException,
	...
	public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName,
		...
		try {
			...
			T newValue = (T) makeEnum(enumType, // The target enum class
					...
					values.size(), classOfArgs, // could be used to pass values
												// to the enum constuctor if
												// needed
					args); // could be used to pass values to the enum
